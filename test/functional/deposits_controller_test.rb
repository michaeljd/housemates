...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { amount: @deposit.amount, date: @deposit.date, description: @deposit.description }
    end
  ...
  test "should update deposit" do
    put :update, id: @deposit, deposit: { amount: @deposit.amount, date: @deposit.date, description: @deposit.description }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
